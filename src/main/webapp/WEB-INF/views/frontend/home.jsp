            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12 col-md-6">
                    <div class="cat-item mb-4 mb-lg-0">
                        <img src="assets/images/about/cat-1.jpg" alt="" class="img-fluid">
                        <div class="item-info">
                ...
                <div class="col-lg-4 col-sm-12 col-md-6">
                    <div class="cat-item mb-4 mb-lg-0">
                        <img src="assets/images/about/cat-2.jpg" alt="" class="img-fluid">
                ...
                <div class="col-lg-4 col-sm-12 col-md-6">
                    <div class="cat-item">
                        <img src="assets/images/about/cat-3.jpg" alt="" class="img-fluid">
                        <div class="item-info">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-12 col-md-6 col-sm-6 mb-5">
                    <div class="product">
                        <div class="product-wrap">
                            <a href="product-single.html"><img class="img-fluid w-100 mb-3 img-first" src="assets/images/shop/products/322.jpg"
                                                               alt="product-img" /></a>
                            <a href="product-single.html"><img class="img-fluid w-100 mb-3 img-second"
                                                               src="assets/images/shop/products/444.jpg" alt="product-img" /></a>
                        </div>

                        <span class="onsale">Sale</span>
                        <div class="product-hover-overlay">
                            <button><i class="tf-ion-android-cart"></i></button>
                            <button class="favorite"><i class="tf-ion-ios-heart"></i></button>
                        </div>
                ...
                <div class="col-lg-3 col-12 col-md-6 col-sm-6 mb-5">
                    <div class="product">
                        <div class="product-wrap">
                            <a href="product-single.html"><img class="img-fluid w-100 mb-3 img-first" src="assets/images/shop/products/111.jpg"
                                                               alt="product-img" /></a>
                            <a href="product-single.html"><img class="img-fluid w-100 mb-3 img-second"
                                                               src="assets/images/shop/products/444.jpg" alt="product-img" /></a>
                        </div>
                ...
                <div class="col-lg-3 col-12 col-md-6 col-sm-6 mb-5">
                    <div class="product">
                        <div class="product-wrap">
                            <a href="product-single.html"><img class="img-fluid w-100 mb-3 img-first" src="assets/images/shop/products/222.jpg"
                                                               alt="product-img" /></a>
                            <a href="product-single.html"><img class="img-fluid w-100 mb-3 img-second"
                                                               src="assets/images/shop/products/322.jpg" alt="product-img" /></a>
                        </div>
                    ...
                    <div class="product">
                        <div class="product-wrap">
                            <a href="product-single.html"><img class="img-fluid w-100 mb-3 img-first" src="assets/images/shop/products/322.jpg"
                                                               alt="product-img" /></a>
                            <a href="product-single.html"><img class="img-fluid w-100 mb-3 img-second"
                                                               src="assets/images/shop/products/111.jpg" alt="product-img" /></a>
                        </div>
                ...
                <div class="col-lg-3 col-12 col-md-6 col-sm-6 mb-5">
                    <div class="product">
                        <div class="product-wrap">
                            <a href="product-single.html"><img class="img-fluid w-100 mb-3 img-first" src="assets/images/shop/products/444.jpg"
                                                               alt="product-img" /></a>
                            <a href="product-single.html"><img class="img-fluid w-100 mb-3 img-second"
                                                               src="assets/images/shop/products/222.jpg" alt="product-img" /></a>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-sm-12 col-md-12">
                    <img src="assets/images/shop/widget/adsv.jpg" alt="Product big thumb"  class="img-fluid w-100">
                </div>
                    ...
                    <div class="widget-featured-entries mt-5 mt-lg-0">
                        ...
                        <div class="media mb-3">
                            <a class="featured-entry-thumb" href="#">
                                <img src="assets/images/shop/widget/p-1.jpg" alt="Product thumb" width="64" class="img-fluid mr-3">
                            </a>
                        ...
                        <div class="media mb-3">
                            <a class="featured-entry-thumb" href="#">
                                <img src="assets/images/shop/widget/p-2.jpg" alt="Product thumb" width="64" class="img-fluid mr-3">
                            </a>
                            <div class="media-body">
                        ...
                        <div class="media mb-3">
                            <a class="featured-entry-thumb" href="#">
                                <img src="assets/images/shop/widget/p-3.jpg" alt="Product thumb" width="64" class="img-fluid mr-3">
                            </a>
                            <div class="media-body">
                        ...
                        <div class="media mb-3">
                            <a class="featured-entry-thumb" href="#">
                                <img src="assets/images/shop/widget/p-4.jpg" alt="Product thumb" width="64" class="img-fluid mr-3">
                            </a>
                            <div class="media-body">
                        ...
                        <div class="media">
                            <a class="featured-entry-thumb" href="#">
                                <img src="assets/images/shop/widget/p-5.jpg" alt="Product thumb" width="64" class="img-fluid mr-3">
                            </a>
                            <div class="media-body">
                ...
                <div class="col-lg-4 col-sm-6 col-md-6">
                    <div class="widget-featured-entries mt-5 mt-lg-0">
                        ...
                        <div class="media mb-3">
                            <a class="featured-entry-thumb" href="#">
                                <img src="assets/images/shop/widget/p-7.jpg" alt="Product thumb" width="64" class="img-fluid mr-3">
                            </a>
                            <div class="media-body">
                                <h6 class="featured-entry-title mb-0"><a href="product-single.html">Keds - Kickstart Pom Pom</a></h6>
                                <p class="featured-entry-meta">$42.99</p>
                        ...
                        <div class="media mb-3">
                            <a class="featured-entry-thumb" href="#">
                                <img src="assets/images/shop/widget/p-8.jpg" alt="Product thumb" width="64" class="img-fluid mr-3">
                            </a>
                            <div class="media-body">
                                <h6 class="featured-entry-title mb-0"><a href="product-single.html">Nike - Brasilia Medium Backpack</a></h6>
                                <p class="featured-entry-meta">$27.99</p>
