        ...
        <div class="main-footer">
            <div class="row g-md-4 gy-sm-5">
                <div class="col-xxl-3 col-xl-4 col-sm-6">
                    <a href="${BASE_URL}" class="foot-logo theme-logo">
                        <img src="${BASE_URL}assets/images/logo/logo-white.png" class="img-fluid blur-up lazyload" alt="">
                    </a>
                ...
                <div class="col-xxl-2 col-xl-4 col-sm-6">
                    <div class="footer-title">
                        <h4 class="text-white">About TrendArena</h4>
                    </div>
